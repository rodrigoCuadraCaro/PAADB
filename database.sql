...
CREATE TABLE certificado(
    ...
    nom_cert    VARCHAR(40) NOT NULL ,
    id_org      INTEGER NOT NULL FOREIGN KEY  REFERENCES organizacion(id_org),
    init_cert   DATE NOT NULL ,
    end_cert    DATE NOT NULL ,
...
CREATE TABLE experiencia(
    ...
    nom_exp  VARCHAR(40) NOT NULL ,
    id_org   INTEGER NOT NULL FOREIGN KEY REFERENCES organizacion (id_org),
    init_exp DATE NOT NULL,
    end_exp  DATE NOT NULL,
...
CREATE TABLE usuario(
    ...
    apes_usuario    VARCHAR(40) NOT NULL,
